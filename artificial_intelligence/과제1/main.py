...
# X 행렬은 [60000, 784]입니다.
# Scorefunction은 X와 W의 내적 연산이므로 W의 행의 갯수는 784이어야 합니다.
# 또한, class 갯수는 10개 이므로 열은 10이어야합니다.
# 그러므로 W는 [784, 10]을 할당해야합니다.
Bias = np.random.random((1, 10))
# class는 총 10개입니다.
# Bias는 class 갯수만큼 가중치를 주는 역할이므로 class 갯수와 같은 크기를 할당해야합니다.
# 그러므로 Bias는 [1, 10]을 할당해야합니다.
